...
namespace PdfiumViewer
{
    ...
    public partial class PdfViewer : UserControl
    {
        ...
        private void _saveButton_Click(object sender, EventArgs e)
        {
            ...
            {
                form.DefaultExt = ".pdf";
                form.Filter = "Save as PDF";
                form.RestoreDirectory = true;
                form.Title = "Save as PDF";
        ...
        public void LoadDocument(string pdffilename)
        {
            try
            {
                ...
                Renderer.Zoom = 1;
                Document = PdfDocument.Load(this, pdffilename);
                
                PageLabel.Text = $"Page {Renderer.Page+1}/{Document.PageCount}";
                Renderer.DisplayRectangleChanged += Renderer_DisplayRectangleChanged;
