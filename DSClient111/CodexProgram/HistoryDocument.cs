...
namespace ILG.Codex.CodexR4
{
    public partial class HistoryDocument : Form
    {
        ...
        public int EditDocumentMode(int Id, bool IsDeletedDocumentMode )
        {
            ...
            //CLinkGrid.Visited = (Form1)FormMain.DSVisited;
        ...
        private void OpenPDFDocument()
        {
            ...
            if (fd.ShowDialog() == DialogResult.OK)
            {
                ...
                this.pdfViewer1.LoadDocument(dstr);
                this.Cursor = System.Windows.Forms.Cursors.Default;
 ...
 //           CCategory.DisplayLayout.Grid.Width = CAuthor.Width;
      ...
      //  private C1.C1Zip.C1ZipFile zfD;
        ...
        private void CreareLinks()
        {
            ...
            File.Delete(DirectoryConfiguration.Instance.DSTemporaryDirectory + @"\LinksSchema.XML");
        ...
        private void DOSaveDocument()
        {
            ...
            if (ILGMessageBox.Show("დოკუმენტის ჩაწერა", "", System.Windows.Forms.MessageBoxButtons.YesNo,
                                  MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) != System.Windows.Forms.DialogResult.Yes) return;
        ...
        {
            if (app.state.RunTimeLicense.IsRecoverDeletedDocumentsGranted() == false)
            {
